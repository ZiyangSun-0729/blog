...
<details class="lake-collapse"><summary id="ub8a60f5a"><span class="ne-text">参数说明</span></summary><p id="uf0b81169" class="ne-p" style="margin: 0; padding: 0; min-height: 24px"><span class="ne-text">runtime-endpoint		</span><span class="ne-text" style="background-color: #FBE4E7">//指定了容器运行时的sock文件位置</span></p><p id="uba42d226" class="ne-p" style="margin: 0; padding: 0; min-height: 24px"><span class="ne-text">image-endpoint		</span><span class="ne-text" style="background-color: #FBE4E7">//指定了容器镜像使用的sock文件位置</span></p><p id="u3951a770" class="ne-p" style="margin: 0; padding: 0; min-height: 24px"><span class="ne-text">timeout				</span><span class="ne-text" style="background-color: #FBE4E7">//容器运行时或容器镜像服务之间的通信超时时间</span></p><p id="u32dcfcd3" class="ne-p" style="margin: 0; padding: 0; min-height: 24px"><span class="ne-text">debug				</span><span class="ne-text" style="background-color: #FBE4E7">//指定了crictl工具的调试模式，false表示调试模式未启用</span></p></details>
